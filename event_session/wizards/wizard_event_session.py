...
class WizardEventSession(models.TransientModel):
    ...
    def _compute_rrule(self):
        for rec in self:
            rec.rrule = str(self._get_rrule()) if self.rrule_type else ""
    ...
    def _create_sessions(self):
        ...
        self.ensure_one()
        session_vals = []
        for date_begin, date_end in self._get_ranges():
            session_vals.append(self._prepare_session_vals(date_begin, date_end))
